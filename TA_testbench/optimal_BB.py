...
feature_dicts = feature_list_test4.get_features_dicts()
...
label_type = 'raw'
results = {}
for tag in ('BB_SMA', 'BB_upperline', 'BB_lowerline'):
    results_interm = {}
    for tau in tau_values:
        feature_dicts['BB']['periods'] = tau
        feature_dicts['BB']['specify_features']['features'] = {  1:{
                                                                   'key': tag,
                                                                   'value': tau
                                                                   }}
        ...
        results_interm[tau] = perf
    results[tag] = results_interm
