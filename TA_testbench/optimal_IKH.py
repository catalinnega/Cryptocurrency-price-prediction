...
feature_dicts = feature_list_test3.get_features_dicts()
...
for tau in tau_values:
    feature_dicts['IKH']['time_span_Tenkan'][0] = int(feature_dicts['IKH']['time_span_Tenkan'][0] * tau)
    feature_dicts['IKH']['time_span_Span_B'][0] = int(feature_dicts['IKH']['time_span_Span_B'][0] * tau)
    feature_dicts['IKH']['displacement_Chikou'][0] = int(feature_dicts['IKH']['displacement_Chikou'][0] * tau)
    feature_dicts['IKH']['displacement'][0] = int(feature_dicts['IKH']['displacement'][0] * tau)
...
plt.figure()
plt.title("Performanta indicatorului ATR")
...
plt.annotate('Minim. ATR = ' +  str(key), xy=(key, val), xytext=(key*4.5, val*1.002),
