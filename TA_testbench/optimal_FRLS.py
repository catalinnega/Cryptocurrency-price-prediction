...
for tau in tau_values:
    feature_dicts['FRLS']['filter length'] = tau
...
plt.figure()
plt.title("Performanta indicatorului FRLS")
...
plt.annotate('Minim(' + "{:.2f}".format(val) + '). FRLS = ' +  str(key), xy=(key, val), xytext=(key*1.3, val*5.9),
