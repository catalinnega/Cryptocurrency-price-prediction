...
for i in range(1,100):
    tau_values.append([int(i* 1.35), int(i * 3.1725), i])
...
for tau in tau_values:
    feature_dicts['MACD']['period_pair'] = tau
...
#import pickle
#with open('macd', 'wb') as f:
#    pickle.dump(results, f)
#
#with open('macd', 'rb') as f:
...
plt.figure()
plt.title("Performanta indicatorului MACD")
...
plt.annotate('Minim. Parametrii MACD = ' + str(key), xy=(key, val), xytext=(key, val*1.02),
