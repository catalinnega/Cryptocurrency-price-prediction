...
feature_dicts = feature_list_test2.get_features_dicts()
...
for tau in tau_values:
    feature_dicts['MFI']['timeframes'] = tau
...
#import pickle
#with open('mfi_100.pkl', 'wb') as f:
#    pickle.dump(results, f)

#with open('mfi_100.pkl', 'rb') as f:
...
plt.figure()
plt.title("Performanta indicatorului MFI")
...
plt.annotate('Minim. MFI = ' +  str(key), xy=(key, val), xytext=(key*1.2, val*1.002),
