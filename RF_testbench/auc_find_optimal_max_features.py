...
max_features = np.arange(np.shape(force_data['test_train_data']['X_train'])[1])[1:]
...
for max_feature in max_features:   
    ...
    rf_obj.get_estimator_sklearn(n_estimators = 10, max_features = max_feature) 
    ...
    auc_scores[max_feature] = (auc_train, auc_test)
    roc_curves[max_feature] = (curve_train, curve_test)
rf_obj.alarm()
