...
for i in range (1,100):
    min_samples_splits.append(i/100)
...
for min_samples_split in min_samples_splits:   
    ...
    rf_obj.get_estimator_sklearn(n_estimators = 10, max_depth = None, min_samples_split = min_samples_split) 
    ...
    auc_scores[min_samples_split] = (auc_train, auc_test)
    roc_curves[min_samples_split] = (curve_train, curve_test)
rf_obj.alarm()
